...
var mouse_position = new THREE.Vector2(1.0, 0.0);
...
function mousePointer(e) {
  mouse_position.x = e.pageX / window.innerWidth;
  mouse_position.y = e.pageY / window.innerHeight;
}
...
function animate() {
  ...
  post_effect.run(mouse_position);
